...
const team = [
  ...
  // { name: 'Rohan Mehta', role: 'Events Lead', emoji: '⚡', twitter: '#', linkedin: '#', github: '#' },
  // { name: 'Divya Gupta', role: 'Marketing Lead', emoji: '📢', twitter: '#', linkedin: '#', github: '#' },
];
          ...
          {team.map((member, i) => (
            ...
            >
              ...
              <div className={styles.avatarWrap}>
                <div className={styles.avatar} style={{ background: gradients[i % gradients.length] }}>
